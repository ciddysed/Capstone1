...
import { StatusChip, TrackingPaper, UserAvatar } from "./styled";
      ...
      try {
        ...
        const documents = response.data.map((doc) => {
          ...
          return {
            ...
            mimeType:
              DOCUMENT_TYPES[docType]?.mimeType ||
              DOCUMENT_TYPES.OTHER.mimeType,
  ...
  const documentsByType = useMemo(
    () => ({
      ...
      other: documents.filter(
        (doc) => doc.type === "General" || doc.type === "Other"
      ),
    }),
    [documents]
  );
                    ...
                    >
                      ...
                      <Box>
                        ...
                        <Typography
                          ...
                          sx={{ maxWidth: 400 }}
                        >
                          Track your application status, view submitted
                          documents, and review your course preferences
                        </Typography>
                      </Box>
                    </Stack>
