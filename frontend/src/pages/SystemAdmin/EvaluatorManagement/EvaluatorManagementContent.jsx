...
const EVALUATOR_API_URL = 'https://eteeap-foth.onrender.com/api/evaluators';
...
const EvaluatorManagementContent = () => {
    ...
    try {
      ...
      setEvaluators(
        evaluatorsData.map(e => ({
          ...e,
          isAdmin: e.isAdmin === 1 || e.isAdmin === true
        }))
      );
    } catch (error) {
        ...
        {selectedEvaluator && (
          <>
            ...
            <DialogContent dividers sx={{ p: 3 }}>
              {/* ...existing dialog content from EvaluatorManagementPage... */}
...
export default EvaluatorManagementContent;
